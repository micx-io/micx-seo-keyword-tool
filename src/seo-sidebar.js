KaToolsV1.ce_define("seo-sidebar", async function($tpl) {
    ...
    scope.result = await MicxSeoKeywordTool.query(await MicxSeoKeywordTool.loadHtml(document.body.innerHTML), scope.lang, scope.method)
    $tpl.render(scope);
}, KaToolsV1.html`
...
<section class="card position-fixed bottom-0 start-0 end-0" style="height: 20px; z-index: 99999;background-color: #ffffff">
